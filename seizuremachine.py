...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    while continueRoutine:
        ...
        if triangle1.status == STARTED:
            ...
            triangle1.setPos((mouse.getPos()[0], mouse.getPos()[1] - 0.5), log=False)
        ...
        if triangle3.status == STARTED:
            ...
            triangle3.setPos((mouse.getPos()[0] - 0.5, mouse.getPos()[1]), log=False)
        ...
        if triangle5.status == STARTED:
            ...
            triangle5.setPos((mouse.getPos()[0], mouse.getPos()[1] + 0.5), log=False)
        ...
        if triangle7.status == STARTED:
            ...
            triangle7.setPos((mouse.getPos()[0] + 0.5, mouse.getPos()[1]), log=False)
        ...
        if triangle8.status == STARTED:
            # update params
            color = random()
            triangle8.setFillColor([0, color, color], log=False)
