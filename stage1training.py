...
expName = 'stage1training'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\legions\\Documents\\Davis\\Neurotech Club\\stimuli\\stage1training.py',
